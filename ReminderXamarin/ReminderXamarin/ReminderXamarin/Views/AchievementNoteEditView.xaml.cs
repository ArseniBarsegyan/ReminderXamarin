...
namespace ReminderXamarin.Views
{
    ...
    public partial class AchievementNoteEditView : ContentPage
    {
        ...
        public AchievementNoteEditView(AchievementViewModel achievementViewModel, AchievementNoteViewModel achievementNoteViewModel)
        {
            InitializeComponent();
